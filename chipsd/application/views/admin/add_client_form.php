                        ...
                        <div class="col-xs-10" style="margin:10px;">
                            <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Enter Table" class="col-xs-10 col-sm-5" name="table"/>
										</div>
									</div>
                                    </div>
                                    <div class="col-xs-10" style="margin:10px;">
                                    ...
                                    <div class="col-xs-10" style="margin:10px;">
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Chips Given</label>
